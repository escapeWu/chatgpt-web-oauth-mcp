...
prepare_launchd_env() {
  ...
  local override_codex_runtime_default_sandbox="${CHATGPT_MCP_CODEX_RUNTIME_DEFAULT_SANDBOX:-}"
  local override_codex_runtime_max_concurrency="${CHATGPT_MCP_CODEX_RUNTIME_MAX_CONCURRENCY:-}"
  local override_codex_runtime_max_runtimes="${CHATGPT_MCP_CODEX_RUNTIME_MAX_RUNTIMES:-}"
  local override_codex_runtime_idle_ttl_seconds="${CHATGPT_MCP_CODEX_RUNTIME_IDLE_TTL_SECONDS:-}"
  local override_codex_runtime_startup_timeout="${CHATGPT_MCP_CODEX_RUNTIME_STARTUP_TIMEOUT_SECONDS:-}"
  local override_codex_runtime_default_timeout_ms="${CHATGPT_MCP_CODEX_RUNTIME_DEFAULT_TIMEOUT_MS:-}"
  local override_codex_runtime_max_timeout_ms="${CHATGPT_MCP_CODEX_RUNTIME_MAX_TIMEOUT_MS:-}"
  local override_codex_runtime_output_max_bytes="${CHATGPT_MCP_CODEX_RUNTIME_OUTPUT_MAX_BYTES:-}"
  local override_codex_runtime_max_message_bytes="${CHATGPT_MCP_CODEX_RUNTIME_MAX_MESSAGE_BYTES:-}"
  ...
  export CHATGPT_MCP_CODEX_RUNTIME_DEFAULT_SANDBOX="${override_codex_runtime_default_sandbox:-${CHATGPT_MCP_CODEX_RUNTIME_DEFAULT_SANDBOX:-workspace-write}}"
  export CHATGPT_MCP_CODEX_RUNTIME_MAX_CONCURRENCY="${override_codex_runtime_max_concurrency:-${CHATGPT_MCP_CODEX_RUNTIME_MAX_CONCURRENCY:-8}}"
  export CHATGPT_MCP_CODEX_RUNTIME_MAX_RUNTIMES="${override_codex_runtime_max_runtimes:-${CHATGPT_MCP_CODEX_RUNTIME_MAX_RUNTIMES:-64}}"
  export CHATGPT_MCP_CODEX_RUNTIME_IDLE_TTL_SECONDS="${override_codex_runtime_idle_ttl_seconds:-${CHATGPT_MCP_CODEX_RUNTIME_IDLE_TTL_SECONDS:-28800}}"
  export CHATGPT_MCP_CODEX_RUNTIME_STARTUP_TIMEOUT_SECONDS="${override_codex_runtime_startup_timeout:-${CHATGPT_MCP_CODEX_RUNTIME_STARTUP_TIMEOUT_SECONDS:-15}}"
  export CHATGPT_MCP_CODEX_RUNTIME_DEFAULT_TIMEOUT_MS="${override_codex_runtime_default_timeout_ms:-${CHATGPT_MCP_CODEX_RUNTIME_DEFAULT_TIMEOUT_MS:-120000}}"
